...
// FIX for onert: comment out android dependency
...
// FIX for onert: for ASharedMemory_create
#ifndef __ANDROID__
#include <fcntl.h>
#endif
...
// FIX for onert: define ASharedMemory_create for non-Android
#ifndef __ANDROID__
...
// FIX for onert: disable hardware dependent test
#if 0
...
// FIX for onert: disable deprecated feature
#if 0
...
// FIX for onert: disable OEM operation test
#if 0
...
// FIX for onert: can run on android
#if 0
