...
private:
  ...
  std::unordered_map<ir::IODesc, std::unique_ptr<backend::IOTensor>> _pkg_input_tensors;
  std::unordered_map<ir::IODesc, std::unique_ptr<backend::IOTensor>> _pkg_output_tensors;
};
